function addSwitcher() {
  ...
  var dzSwitcher =
    '<div id="dzSwitcher" class="styleswitcher-right"> <div class="switcher-btn-bx"><a class="switch-btn closed"><span class="fa fa-cog fa-spin fa-fw"></span></a></div><div class="styleswitcher-inner"> <a href="https://themeforest.net/item/job-board-job-portal-html-bootstrap-4/22712391?ref=Nova Jobs" class="site-button btn-block">Buy Jobboard Now!</a> <h6 class="switcher-title text-center m-tb15">Layout</h6> <ul class="layout-view"> <li class="active"><a href="' +
    urlLTR +
