                  ...
                  <div className="m-t20">
                    <ul className="dez-social-icon dez-social-icon-lg">
                      <li>
                        <Link
                          to={"#"}
                          className="fa fa-facebook bg-primary mr-1"></Link>
                      </li>
                      <li>
                        <Link
                          to={"#"}
                          className="fa fa-twitter bg-primary mr-1"></Link>
                      </li>
                      <li>
                        <Link
                          to={"#"}
                          className="fa fa-linkedin bg-primary mr-1"></Link>
                      </li>
                      <li>
                        <Link
                          to={"#"}
                          className="fa fa-pinterest-p bg-primary mr-1"></Link>
                      </li>
                      <li>
                        <Link
                          to={"#"}
                          className="fa fa-google-plus bg-primary"></Link>
                      </li>
                    </ul>
                  </div>
                </div>
